...
<div class="row">
    ...
    <div class="col lg-5 md-5 mb-5">
            <br><br>
            <h2 class="text-center">Info Ventas</h2><br>
            <table class="container text-center table table-bordered" id="eliminado" >
            <caption>Informacion Venta-Compra</caption>
                <thead class="container table-primary">
                <tr>
                                        <th>Codigo Venta-Compra</th>
                                        <th>Rut Empresa</th>
                                ...
                                <tbody>
                                        ...
                                        <td><?php echo $mostrar['cod_vencom']?></td>
                                        <td><?php echo $mostrar['rut_empresa']?></td>
                                        <td><?php echo $mostrar['num_fact']?></td>
                                        <td><?php echo $mostrar['prec_adqui']?></td>
                                        <td><?php echo $mostrar['fecha_adqui']?></td>
